...
for n_muons in [2,4,6]:
    ...
    print("mask:", mask)
    print("pair combinations:", pair_combinations)

    #charges_sum_ak = ak.sum( (charge_combinations[str(i)] for i in range(n_muons)),axis=1)
    #print("charges sum ak:", charges_sum_ak)
    ...
    #repeating this to avoid crashes
    inv_mass_valid = ( sum((valid_pairs[str(i)] for i in range(n_muons)), zero_momentum) ).mass
